...
const QUESTIONS_DATA = [
    // ---------------- 1-блок: Құндылықтар / Values ---------------- 
    { id: 1, block: 'B1', ru: "Безопасность моей семьи и близких — мой главный приоритет.", kz: "Отбасым мен жақындарымның амандығы — менің басты басымдығым." },
    { id: 2, block: 'B1', ru: "При принятии решений я опираюсь на воспитание родителей и традиции.", kz: "Шешім қабылдағанда ата-ана тәрбиесі мен дәстүрге сүйенемін." },
    { id: 3, block: 'B1', ru: "Сохранение культуры, языка и истории моей страны важно для меня.", kz: "Өз елімнің мәдениетін, тілін және тарихын сақтау мен үшін маңызды." },
    { id: 4, block: 'B1', ru: "Я больше доверяю своей интуиции, чем логике.", kz: "Логикадан гөрі өз ішкі түйсігіме (интуиция) көбірек сенемін." },
    { id: 5, block: 'B1', ru: "Чистота души и честность для меня важнее материального богатства.", kz: "Жан тазалығы мен адалдық мен үшін материалдық байлықтан жоғары." },
    { id: 6, block: 'B1', ru: "При любых обстоятельствах я хочу оставаться верным себе.", kz: "Қандай жағдай болмасын, өз-өзіме адал болып қалуды қалаймын." },
    { id: 7, block: 'B1', ru: "Внутренний покой и гармония — это моё понимание счастья.", kz: "Ішкі тыныштық пен үйлесім — менің бақыт туралы түсінігім." },
    { id: 8, block: 'B1', ru: "Я не занимаюсь работой, противоречащей моим принципам.", kz: "Өз ұстанымдарыма қайшы келетін жұмыспен айналыспаймын." },
    { id: 9, block: 'B1', ru: "Я чувствую ответственность не только за себя, но и за окружающих.", kz: "Тек өзім үшін емес, айналамдағы жандар үшін де жауапкершілік сезінемін." },
    { id: 10, block: 'B1', ru: "Я хочу, чтобы моя будущая работа приносила реальную пользу обществу.", kz: "Болашақ жұмысым қоғамға нақты пайда әкелгенін қалаймын." },

    // ---------------- 2-блок: Қызығушылықтар / Interests ---------------- 
    { id: 11, block: 'B2', ru: "Мне нравится помогать людям и решать их проблемы.", kz: "Адамдарға көмектесу және олардың мәселесін шешу маған ұнайды." },
    { id: 12, block: 'B2', ru: "Мне интересно работать с числами, данными и искать закономерности.", kz: "Сандармен, деректермен жұмыс істеу және заңдылықтар іздеу қызықты." },
    { id: 13, block: 'B2', ru: "Я предпочитаю придумывать новые идеи, а не следовать шаблонам.", kz: "Дайын қалыптан гөрі, жаңа идеялар мен тәсілдер ойлап тапқанды ұнатамын." },
    { id: 14, block: 'B2', ru: "Мне важно видеть результат своей работы в конкретной форме (продукт, результат).", kz: "Еңбегімнің нәтижесін нақты зат (өнім) түрінде көрген мен үшін маңызды." },
    { id: 15, block: 'B2', ru: "Планирование процессов и организация людей меня вдохновляют.", kz: "Үдерістерді жоспарлау және адамдарды ұйымдастыру мені шабыттандырады." },
    { id: 16, block: 'B2', ru: "Мне нравится искать ответы на сложные вопросы и проводить исследования.", kz: "Күрделі сұрақтарға жауап іздеу және зерттеу жасағанды ұнатамын." },
    { id: 17, block: 'B2', ru: "Темы политики, экономики, бизнеса или права мне интересны.", kz: "Саясат, экономика, бизнес немесе құқық тақырыптары маған қызықты." },
    { id: 18, block: 'B2', ru: "Работа с природой, экологией или животными приносит радость.", kz: "Табиғатпен, экологиямен немесе жануарлармен жұмыс істеу қуаныш сыйлайды." },
    { id: 19, block: 'B2', ru: "Мне нравится выступать на публике или быть в центре внимания.", kz: "Көпшілік алдында сөйлеген немесе назарда болған ұнайды." },
    { id: 20, block: 'B2', ru: "Изучение языков и путешествия — мои большие увлечения.", kz: "Тілдерді үйрену және саяхаттау — менің үлкен қызығушылығым." },

    // ---------------- 3-блок: Мотивация / Drive ---------------- 
    { id: 21, block: 'B3', ru: "Если дело интересно, я готов заниматься им бесплатно.", kz: "Егер іс қызықты болса, онымен ақысыз да айналысуға дайынмын." },
    { id: 22, block: 'B3', ru: "Для меня важны высокий статус в обществе и финансовый доход.", kz: "Маған қоғамдағы жоғары мәртебе (статус) және қаржылық табыс маңызды." },
    { id: 23, block: 'B3', ru: "Профессиональные трудности меня не останавливают, а наоборот мотивируют.", kz: "Кәсіби қиындықтар мені тоқтатпайды, қайта жігерлендіреді." },
    { id: 24, block: 'B3', ru: "Мне дает силы видеть, что моя работа меняет жизнь людей.", kz: "Еңбегімнің адамдар өмірін өзгертіп жатқаны маған күш береді." },
    { id: 25, block: 'B3', ru: "Мне необходимо постоянно учиться новому.", kz: "Маған үнемі жаңа нәрсені үйрену өте қажет." },
    { id: 26, block: 'B3', ru: "Стабильность и уверенность в будущем для меня на первом месте.", kz: "Тұрақтылық пен болашаққа деген сенімділік мен үшін басты орында." },
    { id: 27, block: 'B3', ru: "Я хочу быть настоящим мастером в своем деле, эксклюзивным специалистом.", kz: "Өз ісімнің нағыз майталманы, «эксклюзивті» маман болғым келеді." },
    { id: 28, block: 'B3', ru: "Мне нужна свобода действий и независимость на работе.", kz: "Маған жұмыста әрекет ету еркіндігі мен тәуелсіздік керек." },
    { id: 29, block: 'B3', ru: "Моя цель — управлять крупными проектами или командой.", kz: "Менің мақсатым — үлкен жобаларды немесе ұжымды басқару." },
    { id: 30, block: 'B3', ru: "Успех людей, которым я помог, вдохновляет меня.", kz: "Мен көмектескен адамдардың жетістігі мені шабыттандырады." },

    // ---------------- 4-блок: Қабілеттер / Skills ---------------- 
    { id: 31, block: 'B4', ru: "Я легко нахожу ошибки и несоответствия в информации.", kz: "Ақпараттағы қателер мен сәйкессіздіктерді оңай табамын." },
    { id: 32, block: 'B4', ru: "Я умею ясно выражать свои мысли и вести за собой людей.", kz: "Ойымды нақты жеткізіп, адамдарды соңымнан ерте аламын." },
    { id: 33, block: 'B4', ru: "Я хорошо планирую время и координирую дела.", kz: "Уақытты жақсы жоспарлаймын және істерді үйлестіремін." },
    { id: 34, block: 'B4', ru: "Я быстро осваиваю новые программы, технику и гаджеты.", kz: "Жаңа бағдарламаларды, техника мен гаджеттерді тез меңгеремін." },
    { id: 35, block: 'B4', ru: "Я чувствую настроение людей и быстро нахожу общий язык.", kz: "Адамдардың көңіл-күйін сеземін және тез тіл табысамын." },
    { id: 36, block: 'B4', ru: "Я сохраняю спокойствие и принимаю быстрые решения в стрессовых ситуациях.", kz: "Стресс кезінде сабыр сақтап, жылдам шешім қабылдай аламын." },
    { id: 37, block: 'B4', ru: "Я умею делать что-то руками или создавать дизайн.", kz: "Қолмен бірдеңе жасау немесе дизайн құрастыру қолымнан келеді." },
    { id: 38, block: 'B4', ru: "Я быстро выделяю самое важное из большого объема информации.", kz: "Көп ақпараттың ішінен ең маңыздысын тез бөліп аламын." },
    { id: 39, block: 'B4', ru: "Я могу эффективно выполнять несколько задач одновременно.", kz: "Бір уақытта бірнеше істі нәтижелі атқара аламын." },
    { id: 40, block: 'B4', ru: "Я умею гасить конфликты и находить компромиссы.", kz: "Кикілжіңдерді (конфликт) басып, ымыраға келуге шебермін." },

    // ---------------- 5-блок: Орта / Environment ---------------- 
    { id: 41, block: 'B5', ru: "Я лучше работаю, когда сам планирую рабочий график.", kz: "Жұмыс кестесін өзім реттегенде жақсырақ жұмыс істеймін." },
    { id: 42, block: 'B5', ru: "Высокий темп и динамика работы придают мне сил.", kz: "Жұмыстың жоғары қарқыны мен динамикасы маған күш береді." },
    { id: 43, block: 'B5', ru: "Важно быть частью команды и постоянно взаимодействовать.", kz: "Ұжымның бір бөлігі болу және үнемі араласу мен үшін маңызды." },
    { id: 44, block: 'B5', ru: "Мне важно работать по четким правилам и инструкциям.", kz: "Нақты ережелер мен нұсқаулықтар бойынша жұмыс істегенді қалаймын." },
    { id: 45, block: 'B5', ru: "Мне интересна международная среда и общение с иностранцами.", kz: "Халықаралық орта және шетелдіктермен байланыс маған қызықты." },
    { id: 46, block: 'B5', ru: "Я хочу, чтобы моя работа была связана с поездками и командировками.", kz: "Жұмысым саяхаттармен және іссапарлармен байланысты болғанын қалаймын." },
    { id: 47, block: 'B5', ru: "Мне нужен офис с современными технологиями.", kz: "Маған ең заманауи технологиялармен жабдықталған орын керек." },
    { id: 48, block: 'B5', ru: "Важна «семейная», теплая атмосфера в коллективе.", kz: "Ұжымдағы «отбасылық», жылы атмосфера мен үшін маңызды." },
    { id: 49, block: 'B5', ru: "Я не могу сидеть на месте, мне нужна физическая активность.", kz: "Бір орында отыра алмаймын, физикалық белсенділік керек." },
    { id: 50, block: 'B5', ru: "Я хорошо себя чувствую в изменяющейся среде, где есть риск.", kz: "Тәуекелге баруға болатын өзгермелі ортада өзімді жақсы сезінемін." },

    // ---------------- 6-блок: Бейімділік / Superpower ---------------- 
    { id: 51, block: 'B6', ru: "Мастер слова (Лингвистический талант).", kz: "Сөз мергені (Лингвистикалық талант)." },
    { id: 52, block: 'B6', ru: "Логический сканер (Аналитический талант).", kz: "Логикалық сканер (Аналитикалық талант)." },
    { id: 53, block: 'B6', ru: "Пространственное восприятие (3D/Визуальный талант).", kz: "Кеңістік көруші (3D/Визуалды талант)." },
    { id: 54, block: 'B6', ru: "Телесная ловкость (Кинестетический талант).", kz: "Дене шеберлігі (Кинестетикалық талант)." },
    { id: 55, block: 'B6', ru: "Музыкальный слух (Музыкальный талант).", kz: "Әуен сезгіш (Музыкалық талант)." },
    { id: 56, block: 'B6', ru: "Радар эмпатии (Психологический талант).", kz: "Эмпатия «Радары» (Психологиялық талант)." },
    { id: 57, block: 'B6', ru: "Внутренний компас (Личностный талант).", kz: "Ішкі компас (Тұлғаішілік талант)." },
    { id: 58, block: 'B6', ru: "Природный исследователь (Натуралист).", kz: "Табиғат тілшісі (Натуралист)." },
    { id: 59, block: 'B6', ru: "Систематизатор (Организатор).", kz: "Жүйелеуші (Систематизатор)." },
    ...
    renderRes(res) {
        ...
        this.ui.recommendations.innerHTML = `
            ...
            <div class="recommendation-item">
                ...
                <p>${this.lang === 'ru' ? 
                    `Сфокусируйтесь на усилении блока ${t.blockNames[top1]}. Используйте вашу суперсилу для решения сложных аналитических задач.` : 
                    `${t.blockNames[top1]} блогын нығайтуға назар аударыңыз. Күрделі аналитикалық есептерді шешу үшін суперкүшіңізді пайдаланыңыз.`}</p>
            </div>
        `;
